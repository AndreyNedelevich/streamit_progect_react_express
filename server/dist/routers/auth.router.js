...
router.get("/register/:token", auth_middleware_1.authMiddleware.checkActionToken(action_token_type_enum_1.EActionTokenTypes.Activate), auth_controller_1.authController.activate);
router.post("/activate", auth_middleware_1.authMiddleware.checkAccessToken, middlewares_1.userMiddleware.findUser("email"), auth_controller_1.authController.sendActivationEmail);
...
router.put("/forgot/:token", middlewares_1.commonMiddleware.isBodyValid(validators_1.UserValidator.setForgotPassword), auth_middleware_1.authMiddleware.checkActionToken(action_token_type_enum_1.EActionTokenTypes.Forgot), auth_controller_1.authController.setForgotPassword);
