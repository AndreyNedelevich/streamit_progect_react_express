...
router.post("/register/:token", auth_middleware_1.authMiddleware.checkActionToken(action_token_type_enum_1.EActionTokenTypes.Activate), auth_controller_1.authController.activate);
